...
Example of this would be, as a woman at the same time is a mother, a wife, an employee. So the same person posses different behavior in different situations. This is called polymorphism.
